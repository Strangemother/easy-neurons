...
def train_once_with_loss(input_val, expected_output_info, learning_rate, weights, biases):
    ...
    total_error = np.sum(output_error) # no **2 here because thats done in the custom_loss
...
do_all()
# train_network(training_data_1_1, weights, biases, epochs=10_000);do_all()
predict_many(0.1)
