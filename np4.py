...
def x_train_network(data, weights, biases, learning_rate=0.1, epochs=10000):
    for epoch in range(epochs):
        ...
        # Optionally print out the error every so often
        if epoch % 1000 == 0:
...
v = predict_next_letter_updated('w')
print(f'Predicted letter: w -> {v}')

v = predict_next_letter_updated('e')
print(f'Predicted letter: e -> {v}')

v = predict_next_letter_updated('a')
print(f'Predicted letter: a -> {v}')
